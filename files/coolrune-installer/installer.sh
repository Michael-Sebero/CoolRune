...
retry_pacman 5 pacman -Syyu --noconfirm --needed --overwrite='*' alhp-keyring && mv /home/coolrune-files/files/coolrune-manual/Manual /home/$USER/Desktop/ && timeout 0.5 speaker-test -t sine > /dev/null 2>&1 &&
