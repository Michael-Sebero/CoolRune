...
echo -e \"\e[1mSetting up initial environment...\e[0m\"
...
pacman -Sy --noconfirm artix-archlinux-support pacman-contrib
...
rankmirrors -v -n 5 -m 2 /etc/pacman.d/mirrorlist > /etc/pacman.d/mirrorlist.new
mv /etc/pacman.d/mirrorlist.new /etc/pacman.d/mirrorlist
chmod 644 /etc/pacman.d/mirrorlist

# FIRST COMMANDS AND COOLRUNE IMPORT P2
echo -e \"\e[1mUpdating system packages...\e[0m\"
...
timeout 0.5 speaker-test -t sine > /dev/null 2>&1
...
# FLATPAK PACKAGES
echo -e \"\e[1mInstalling Flatpak packages...\e[0m\"
